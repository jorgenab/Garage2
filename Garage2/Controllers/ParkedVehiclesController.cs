...
namespace Garage2.Controllers
{
    public class ParkedVehiclesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,VehicleType,RegistrationNumber,NumberOfWheels,Color,Brand,Model,TimeOfParking")] ParkedVehicle parkedVehicle)
        {
